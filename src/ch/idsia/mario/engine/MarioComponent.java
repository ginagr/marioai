...
//            scene.keys = action;
            ...
            if (GlobalOptions.VisualizationOn) {
                ...
                if (GlobalOptions.Overlay) LevelScene.drawStringDropShadow(og, msg, 0, 7, 5);

                msg = "Selected Actions: ";
                if (GlobalOptions.Overlay) LevelScene.drawStringDropShadow(og, msg, 0, 8, 6);
                ...
                if (action != null)
                {
                    ...
                    msg = "NULL";                    
                if (GlobalOptions.Overlay) drawString(og, msg, 6, 78, 1);
...
//                    og.drawString(msgClick, 320 + 1, 20 + 1);
                ...
                if (GlobalOptions.Overlay) LevelScene.drawStringDropShadow(og, "FPS: ", 33, 2, 7);
                if (GlobalOptions.Overlay) LevelScene.drawStringDropShadow(og, ((GlobalOptions.FPS > 99) ? "\\infty" : GlobalOptions.FPS.toString()), 33, 3, 7);

                msg = totalNumberOfTrials == -2 ? "" : currentTrial + "(" + ((totalNumberOfTrials == -1) ? "\\infty" : totalNumberOfTrials) + ")";

                if (GlobalOptions.Overlay) LevelScene.drawStringDropShadow(og, "Trial:", 33, 4, 7);
                if (GlobalOptions.Overlay) LevelScene.drawStringDropShadow(og, msg, 33, 5, 7);
