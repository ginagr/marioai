...
//        drawStringDropShadow(g, "#########", 0, 1, 7);
        ...
        if (GlobalOptions.Overlay) {
            drawStringDropShadow(g, "DIFFICULTY:   " + df.format(this.levelDifficulty), 0, 0, this.levelDifficulty > 6 ? 1 : this.levelDifficulty > 2 ? 4 : 7);
            drawStringDropShadow(g, "CREATURES:" + (mario.world.paused ? "OFF" : "ON"), 19, 0, 7);
            drawStringDropShadow(g, "SEED:" + this.levelSeed, 0, 1, 7);
            drawStringDropShadow(g, "TYPE:" + LEVEL_TYPES[this.levelType], 0, 2, 7);
            drawStringDropShadow(g, "ALL KILLS: " + killedCreaturesTotal, 19, 1, 1);
            drawStringDropShadow(g, "LENGTH:" + (int) mario.x / 16 + " of " + this.levelLength, 0, 3, 7);
            ...
            drawStringDropShadow(g, "MUSHROOMS: " + df.format(Mario.gainedMushrooms), 0, 5, 4);
        ...
        if (GlobalOptions.Overlay) drawStringDropShadow(g, " "+df2.format(time), 33, 1, 7);
