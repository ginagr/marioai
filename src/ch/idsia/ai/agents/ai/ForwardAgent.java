...
//        for(int i = 0; i < marioPos.length; i++) {
//            System.out.println("marioPos: " + marioPos[i]);
//        }
//        for (float enemiesPo : enemiesPos) {
//            System.out.println("enemiesPos: " + enemiesPo);
//        }
//        System.out.println("");

        String encodedState = observation.getBitmapLevelObservation();
        byte[][] levelSceneFromBitmap = decode(encodedState);
//        String encodedState = observation.getBitmapEnemiesObservation();
